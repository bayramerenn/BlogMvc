                                ...
                                $.each(commentResult.Data.Comments.$values,
                                    function (index, comment) {
                                        ...
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            `
                                <button class="btn btn-warning btn-sm btn-undo" data-id="${newComment.CommentId}"><span class="fas fa-undo"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete" data-id="${newComment.CommentId}"><span class="fas fa-minus-circle"></span></button>
                                            `
                                        ]).node();
