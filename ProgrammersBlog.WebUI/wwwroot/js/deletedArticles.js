                                ...
                                $.each(articleResult.Data.Articles.$values,
                                    function (index, article) {
                                        ...
                                        const newTableRow = dataTable.row.add([
                                            ...
                                            `
                                <button class="btn btn-primary btn-sm btn-undo" data-id="${newArticle.ArticleId}"><span class="fas fa-undo"></span></button>
                                <button class="btn btn-danger btn-sm btn-delete" data-id="${newArticle.ArticleId}"><span class="fas fa-minus-circle"></span></button>
                                            `
                                        ]).node();
